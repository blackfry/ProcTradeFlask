...
/***/ function(module, exports, __webpack_require__) {
	...
	var aapi = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Instruments = __webpack_require__(159);
	...
	module.exports = React.createClass({
		...
		content: function content() {
			if (this.props.children) {
				...
				return React.createElement(Instruments, null);
			}
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var the_api = __webpack_require__(160);
	var Reflux = __webpack_require__(162);
	var InstrumentStore = __webpack_require__(182);
	...
	module.exports = React.createClass({
		...
		mixins: [Reflux.listenTo(InstrumentStore, 'onChange')],
		...
		renderInstruments: function renderInstruments() {
			return this.state.instruments.slice(0, 10).map(function (instrument) {
				return React.createElement(
					'div',
					{ className: "list-group-item", key: instrument.displayName },
					React.createElement(
						'h4',
						null,
					...
					React.createElement(
						...
						React.createElement(
							...
							null,
							'Maximum Trade Unit: ',
							instrument.maxTradeUnits
						)
					)
				);
			});
		},
		onChange: function onChange(event, instruments) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var https;
	var Fetch = __webpack_require__(161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ListenerMethods = __webpack_require__(165);

	exports.PublisherMethods = __webpack_require__(175);

	exports.StoreMethods = __webpack_require__(174);

	exports.createAction = __webpack_require__(178);

	exports.createStore = __webpack_require__(170);

	exports.connect = __webpack_require__(179);

	exports.connectFilter = __webpack_require__(164);
	...
	var _ = exports.utils = __webpack_require__(166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(definition) {
	    ...
	    var StoreMethods = __webpack_require__(174),
	        PublisherMethods = __webpack_require__(175),
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = Reflux.createStore({
		...
		getInstruments: function getInstruments() {
			return the_api.get('/v1/instruments').then((function (json) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = Reflux.createActions(['getInstruments']);
